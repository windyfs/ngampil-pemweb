          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-8">
              <div class="swiper-slide">
                <img style="width: 700px;" src="assets/img/casualk2.jpeg" alt="">
              </div>
            </div>
              ...
              <div class="portfolio-info">
                ...
                <form action="transaction.php" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <?php
                    $sql = "SELECT id_produk FROM produk WHERE id_produk = 'PD006'";
                    $query = mysqli_query($conn, $sql);
                  ...
                  <div class="form-group">
                    ...
                    <?php
                    $sql = "SELECT nama_produk FROM produk WHERE id_produk = 'PD006'";
                    $query = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($query);
                  ...
                  <div class="form-group">
                    ...
                    <?php
                    $sql = "SELECT harga_produk FROM produk WHERE id_produk = 'PD00'";
                    $query = mysqli_query($conn, $sql);
                    $row = mysqli_fetch_assoc($query);

                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-8">
                            <div class="swiper-slide">
                                <img style="width: 700px;"src="assets/img/casualpr1.jpeg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="portfolio-info">
                                ...
                                <form action="transaction.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $sql = "SELECT id_produk FROM produk WHERE id_produk = 'PD003'";
                                        $query = mysqli_query($conn, $sql);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $sql = "SELECT nama_produk FROM produk WHERE id_produk = 'PD003'";
                                        $query = mysqli_query($conn, $sql);
                                        $row = mysqli_fetch_assoc($query);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $sql = "SELECT harga_produk FROM produk WHERE id_produk = 'PD003'";
                                        $query = mysqli_query($conn, $sql);
                                        $row = mysqli_fetch_assoc($query);
                            ...
                            <div class="portfolio-description">
                                ...
                                <p>
                                    Women Casual Midi Dress adalah sebuah pakaian wanita yang memberikan tampilan santai
                                    namun tetap stylish dan elegan. Midi dress mengacu pada panjangnya pakaian yang berada
                                    di antara lutut dan pergelangan kaki, memberikan kesan yang sangat feminin dan anggun.
                                </p>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <ul>
                                ...
                                <li><i class="bx bx-chevron-right"></i> <a href="portfolio-details.html">Detail Sewa</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <div class="social-links mt-3">
                                ...
                                <a href="https://fasilkom.upnjatim.ac.id/" class="instagram"><i
